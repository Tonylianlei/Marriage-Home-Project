package com.example.demo.dataconnect.config;

import com.example.demo.dataconnect.BaseConnectConfig;
...
public class BaseConfig extends BaseConnectConfig implements TransactionManagementConfigurer {
